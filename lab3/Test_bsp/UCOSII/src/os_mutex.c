...
/*$PAGE*/
    ...
    if ((INT8U)(pevent->OSEventCnt & OS_MUTEX_KEEP_LOWER_8) == OS_MUTEX_AVAILABLE) {
        ...
        output_buffer[output_tail].time = OSTime;                   /* lab3 */
        output_buffer[output_tail].event = 'l';                     /* lab3 */
        output_buffer[output_tail].task1 = OSTCBCur->OSTCBPrio;     /* lab3 */
        // task2 in below
        output_buffer[output_tail].src = pip;                       /* lab3 */
        ...
        if (ptcb->OSTCBPrio > pip) { 
            ...
            output_buffer[output_tail].task2 = pip;        /* lab3 */
            ...
            output_buffer[output_tail].task2 = OSTCBCur->OSTCBPrio; /* lab3 */
        }
        output_tail++;                                              /* lab3 */
        OS_EXIT_CRITICAL();
...
INT8U  OSMutexPost (OS_EVENT *pevent)
{
    ...
    output_buffer[output_tail].time = OSTime;                   /* lab3 */
    output_buffer[output_tail].event = 'u';                     /* lab3 */
    output_buffer[output_tail].task1 = OSTCBCur->OSTCBPrio;     /* lab3 */
    output_buffer[output_tail].task2 = prio;                    /* lab3 */
    output_buffer[output_tail].src = pip;                       /* lab3 */
    output_tail++;                                              /* lab3 */
    OSPrioCur = prio;                                           /* lab3 */
